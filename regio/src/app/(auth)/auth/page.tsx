...
import { FaArrowRightArrowLeft, FaEnvelope, FaLock, FaTicket, FaCircleInfo, FaUsers, FaPenNib } from "react-icons/fa6";
      ...
      <div className="bg-white rounded-t-[25px] flex-grow p-[30px] shadow-[0_-5px_20px_rgba(0,0,0,0.05)] animate-in slide-in-from-bottom-10 duration-500 flex flex-col">
        ...
        {view === 'login' ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); window.location.href = '/'; }}>
              <div className="mb-[20px]">
                ...
                <div className="relative">
                  ...
                  <input type="email" className="w-full p-[14px_14px_14px_45px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] focus:border-[var(--color-green-offer)] outline-none" placeholder="you@example.com" required />
                </div>
              </div>
              ...
              <div className="mb-[20px]">
                ...
                <div className="relative">
                  ...
                  <input type="password" className="w-full p-[14px_14px_14px_45px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] focus:border-[var(--color-green-offer)] outline-none" placeholder="••••••••" required />
                </div>
              ...
              <button type="submit" className="w-full p-[15px] bg-[var(--color-green-offer)] text-white border-none rounded-[8px] text-[16px] font-bold cursor-pointer mt-[10px] shadow-[0_4px_10px_rgba(140,179,72,0.3)] active:scale-95 transition-transform">
                {t.btnLogin}
              </button>
            </form>
          ...
          <div className="animate-in fade-in duration-300">
            ...
            <form onSubmit={(e) => { e.preventDefault(); alert('Registration simulated!'); }}>
              ...
              <div className="bg-[#f0f7e6] border border-dashed border-[var(--color-green-offer)] p-[15px] rounded-[8px] mb-[10px] text-center">
                ...
                <div className="relative bg-white rounded-[6px]">
                  ...
                  <input type="text" className="w-full p-[14px_14px_14px_45px] border border-[#ddd] rounded-[8px] text-[15px] text-center font-mono font-bold tracking-[1px] uppercase outline-none" placeholder="REGIO-XXXX" required />
                </div>
              </div>
              ...
              <div className="flex gap-[10px] mb-[20px]">
                <div className="flex-1">
                  ...
                  <input type="text" className="w-full p-[14px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] outline-none" placeholder="John" required />
                </div>
                <div className="flex-1">
                  <label className="block text-[12px] font-bold text-[#555] mb-[8px]">{t.lname}</label>
                  <input type="text" className="w-full p-[14px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] outline-none" placeholder="Doe" required />
                </div>
              </div>

              <div className="mb-[20px]">
                <label className="block text-[12px] font-bold text-[#555] mb-[8px]">{t.email}</label>
                <input type="email" className="w-full p-[14px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] outline-none" placeholder="you@example.com" required />
              </div>

              <div className="mb-[20px]">
                <label className="block text-[12px] font-bold text-[#555] mb-[8px]">{t.createPass}</label>
                <input type="password" className="w-full p-[14px] border border-[#ddd] rounded-[8px] text-[15px] bg-[var(--input-bg)] outline-none" placeholder="Min. 8 chars" required />
              </div>

              <div className="flex gap-[10px] items-start text-[12px] text-[#666] mb-[15px]">
                <input type="checkbox" id="agb" required className="mt-[2px]" />
